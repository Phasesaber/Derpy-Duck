...
function() {
	function a() {
		if (!f) {
			...
			document.removeEventListener ? document.removeEventListener("DOMContentLoaded", a, !1) : window.removeEventListener("load", a, !1), f = !0;
			for (var b = 0; b < g.length; b++) g[b].call(window, []);
			g.length = 0
		}
	}

	function b() {
		return e ? void 0 : (e = !0, "complete" === document.readyState ? a() : (document.addEventListener && document.addEventListener("DOMContentLoaded", a, !1), void window.addEventListener("load", a, !1)))
	}

	function c() {
		d || (me.device._check(), me.save._init(), me.loader.setNocache(document.location.href.match(/\?nocache/) || !1), me.timer.init(), me.mapReader = new me.TMXMapReader, me.state.init(), me.pool.init(), me.device.isMobile === !1 && me.input._enableKeyboardEvent(), me.levelDirector.reset(), d = !0)
	}
	me.mod = "melonJS", me.version = "1.0.2", "function" == typeof define && define.amd && define("me", [], function() {
		return me
	}), me.sys = {
		fps: 60,
		interpolation: !1,
	...
	window.onReady = function(a) {
		return b(), f ? a.call(window, []) : g.push(function() {
	...
	var h = !1,
		i = /var xyz/.test(function() {}) ? /\bparent\b/ : /[\D|\d]*/;
	Object.defineProperty || (Object.defineProperty = function(a, b, c) {
		if (!a.__defineGetter__) throw "melonJS: Object.defineProperty not supported";
	...
	var j = function(a) {
		...
		if (a instanceof Array) {
			b = [], Object.setPrototypeOf(b, Object.getPrototypeOf(a));
			for (var c = 0, d = a.length; d > c; c++) b[c] = j(a[c]);
			return b
		}
		if (a instanceof Date) return b = new Date, b.setTime(a.getTime()), b;
		b = {}, Object.setPrototypeOf(b, Object.getPrototypeOf(a));
		for (var e in a) a.hasOwnProperty(e) && (b[e] = j(a[e]));
		return b
	};
	if (Object.extend = function(a) {
		function b(a, b) {
			return function() {
				var c = this.parent;
				this.parent = d[a];
				var e = b.apply(this, arguments);
				return this.parent = c, e
			}
		}

		function c() {
			if (!h) {
				for (var a in this) "object" == typeof this[a] && (this[a] = j(this[a]));
		...
		var e = new this;
		h = !1;
		for (var f in a) a.hasOwnProperty(f) && (e[f] = "function" == typeof a[f] && "function" == typeof d[f] && i.test(a[f]) ? b(f, a[f]) : a[f]);
		return c.prototype = e, c.constructor = c, c.extend = Object.extend, c
		...
		Function.prototype.bind = function(a) {
			...
			return b.prototype && (k.prototype = b.prototype, d.prototype = new k, k.prototype = null), d
		}
	}
	if (window.throttle || (window.throttle = function(a, b, c) {
	...
	}), "undefined" == typeof window.performance && (window.performance = {}), !window.performance.now) {
		var l = Date.now();
		window.performance.timing && window.performance.timing.navigationStart && (l = window.performance.timing.navigationStart), window.performance.now = function() {
			return Date.now() - l
		}
	}
	"undefined" == typeof console && (console = {
		...
		return a.__proto__
	}, Object.setPrototypeOf || (Object.setPrototypeOf = navigator.userAgent.match(/MSIE/i) ? Object.setPrototypeOf || function(a, b) {
		...
		var a = arguments.length < 2 ? this : arguments[0],
			b = Math.pow(10, arguments[1] || arguments[0] || 0);
		...
		var a = {},
			...
			e = 0,
			f = 1;
		return a.viewport = null, a.collisionMap = null, a.currentLevel = null, a.world = null, a.mergeGroup = !0, a.sortOn = "z", a.renderer = null, a.NO_OBJECT = 0, a.ENEMY_OBJECT = 1, a.COLLECTABLE_OBJECT = 2, a.ACTION_OBJECT = 3, a.onLevelLoaded = null, a.init = function(e, f) {
			c || (e = e || me.video.getWidth(), f = f || me.video.getHeight(), a.viewport = new me.Viewport(0, 0, e, f), a.world = new me.ObjectContainer(0, 0, e, f), a.world.name = "rootContainer", b = me.video.getSystemContext(), me.event.publish(me.event.GAME_INIT), me.input._translatePointerEvents(), d = !0, a.currentLevel = {
				pos: {
					x: 0,
					y: 0
				}
			}, a.defaultCollisionMap = new me.CollisionTiledLayer(0, 0), c = !0)
		}, a.reset = function() {
			a.world.destroy(), a.viewport && a.viewport.reset(), a.currentLevel = {
				pos: {
					x: 0,
					y: 0
				}
			}, a.collisionMap = a.defaultCollisionMap, b.setTransform(1, 0, 0, 1, 0, 0), e = 0, f = Math.round(60 / me.sys.fps)
		}, a.getParentContainer = function(a) {
			return a.ancestor
		}, a.repaint = function() {
			d = !0
		}, a.update = function(b) {
			++e % f === 0 && (e = 0, me.timer.update(b), d = a.world.update(me.timer.getDelta()) || d, d = a.viewport.update(me.timer.getDelta()) || d)
		}, a.draw = function() {
			if (d) {
				var c = a.viewport.pos.x + ~~a.viewport.offset.x,
					e = a.viewport.pos.y + ~~a.viewport.offset.y;
				a.world.transform.translate(-c, -e), a.viewport.screenX = c - a.currentLevel.pos.x, a.viewport.screenY = e - a.currentLevel.pos.y, a.world.draw(b, a.viewport), a.world.transform.translate(c, e), a.viewport.draw(b)
			}
			d = !1, me.video.blitSurface()
		}, a
	}()
}(),
function() {
...
function() {
	me.device = function() {
		...
		return c._check = function() {
			...
			me.device.isMobile = me.device.ua.match(/Android|iPhone|iPad|iPod|BlackBerry|Windows Phone|Mobi/i) || !1, me.device.iOS = me.device.ua.match(/iPhone|iPad|iPod/i) || !1, me.device.android = me.device.ua.match(/android/i) || !1, me.device.android2 = me.device.ua.match(/android 2/i) || !1, me.device.wp = me.device.ua.match(/Windows Phone/i) || !1
		}, c.ua = navigator.userAgent, c.localStorage = !1, c.hasAccelerometer = !1, c.hasDeviceOrientation = !1, c.hasFullscreenSupport = !1, c.hasPointerLockSupport = !1, c.nativeBase64 = "function" == typeof window.atob, c.touch = !1, c.isMobile = !1, c.iOS = !1, c.android = !1, c.android2 = !1, c.wp = !1, c.orientation = 0, c.accelerationX = 0, c.accelerationY = 0, c.accelerationZ = 0, c.gamma = 0, c.beta = 0, c.alpha = 0, c.requestFullscreen = function(a) {
			...
			if (null === f) {
				var a = me.video.getScreenContext(),
			...
			throw "melonJS : storage type " + a + " not supported"
...
function() {
	me.pool = function() {
		...
		return a.init = function() {
			a.register("me.ObjectEntity", me.ObjectEntity), a.register("me.CollectableEntity", me.CollectableEntity), a.register("me.LevelEntity", me.LevelEntity), a.register("TileObject", me.SpriteObject), a.register("me.Tween", me.Tween, !0), a.register("me.Color", me.Color, !0), a.register("me.Particle", me.Particle, !0)
		}, a.register = function(a, c, d) {
			return d ? void(b[a.toLowerCase()] = {
				"class": c,
				pool: []
			}) : void(b[a.toLowerCase()] = {
				"class": c,
				pool: void 0
			})
		}, a.pull = function(a) {
			var c = "string" == typeof a ? a.toLowerCase() : void 0,
...
function() {
	me.Vector2d = Object.extend({
		...
		set: function(a, b) {
			if (a !== +a || b !== +b) throw "melonjs: invalid x,y parameters for me.Vector2d (not a number)";
...
function() {
	me.Rect = Object.extend({
		...
		shapeType: "Rectangle",
		init: function(a, b, c) {
			this.pos.setV(a), this.rangeV.set(0, 0), this.width = b, this.height = c, this.hWidth = ~~ (b / 2), this.hHeight = ~~ (c / 2), Object.defineProperty(this, "left", {
				get: function() {
					var a = this.pos.x,
						b = a + this.rangeV.x;
					return b > a ? a : b
		...
		setShape: function(a, b, c) {
			return this.pos.setV(a), this.resize(b, c), this
		},
		resize: function(a, b) {
			return this.width = a, this.height = b, this.hWidth = ~~ (a / 2), this.hHeight = ~~ (b / 2), this
		},
		getBounds: function(a) {
			return "undefined" != typeof a ? a.setShape(this.pos, this.width, this.height) : this.clone()
		},
		clone: function() {
		...
		addV: function(a) {
			return this.rangeV.setV(a), this
		},
		union: function(a) {
		...
		flipX: function(a) {
			return this.pos.x = a - this.width - this.pos.x, this
		},
		flipY: function(a) {
			return this.pos.y = a - this.height - this.pos.y, this
		},
		equals: function(a) {
			return this.left === a.left && this.right === a.right && this.top === a.top && this.bottom === a.bottom
		},
		overlaps: function(a) {
		...
		collideWithRectangle: function(a) {
			var b = new me.Vector2d(0, 0);
			if (this.overlaps(a)) {
				var c = this.left + this.hWidth - a.left - a.hWidth,
					d = this.top + this.hHeight - a.top - a.hHeight;
				b.x = a.hWidth + this.hWidth - (0 > c ? -c : c), b.y = a.hHeight + this.hHeight - (0 > d ? -d : d), b.x < b.y ? (b.y = 0, b.x = 0 > c ? -b.x : b.x) : (b.x = 0, b.y = 0 > d ? -b.y : b.y)
			}
			return b
		},
		draw: function(a, b) {
			a.strokeStyle = b || "red", a.strokeRect(this.left, this.top, this.width, this.height)
		}
	})
}(),
function() {
	me.Ellipse = Object.extend({
		...
		setShape: function(a, b, c) {
			return this.radius.set(b / 2, c / 2), this.pos.setV(a).add(this.radius), this
		},
		translate: function(a, b) {
			return this.pos.x += a, this.pos.y += b, this
		},
		translateV: function(a) {
			return this.pos.add(a), this
		},
		containsPointV: function(a) {
			return this.containsPoint(a.x, a.y)
		},
		containsPoint: function(a, b) {
			return a -= this.pos.x, b -= this.pos.y, a * a / (this.radius.x * this.radius.x) + b * b / (this.radius.y * this.radius.y) <= 1
		},
		getBounds: function(a) {
			return "undefined" != typeof a ? a.setShape(this.pos.clone().sub(this.radius), 2 * this.radius.x, 2 * this.radius.y) : new me.Rect(this.pos.clone().sub(this.radius), 2 * this.radius.x, 2 * this.radius.y)
		},
		clone: function() {
			return new me.Ellipse(this.pos, 2 * this.radius.x, 2 * this.radius.y)
		},
		draw: function(a, b) {
			a.save(), a.beginPath(), a.translate(this.pos.x - this.radius.x, this.pos.y - this.radius.y), a.scale(this.radius.x, this.radius.y), a.arc(1, 1, 1, 0, 2 * Math.PI, !1), a.restore(), a.strokeStyle = b || "red", a.stroke()
		}
	})
}(),
function() {
	me.PolyShape = Object.extend({
		...
		setShape: function(a, b, c) {
			return this.pos.setV(a), this.points = b, this.closed = c === !0, this.getBounds(), this
		},
		translate: function(a, b) {
			return this.pos.x += a, this.pos.y += b, this
		},
		...
		getBounds: function(a) {
			var b = this.pos.clone(),
				c = 0,
				d = 0;
			return this.points.forEach(function(a) {
				b.x = Math.min(b.x, a.x), b.y = Math.min(b.y, a.y), c = Math.max(c, a.x), d = Math.max(d, a.y)
			}), "undefined" != typeof a ? a.setShape(b, c - b.x, d - b.y) : new me.Rect(b, c - b.x, d - b.y)
		},
		clone: function() {
			var a = [];
			return this.points.forEach(function(b) {
				a.push(new me.Vector2d(b.x, b.y))
			}), new me.PolyShape(this.pos.clone(), a, this.closed)
		},
		draw: function(a, b) {
			a.save(), a.translate(-this.pos.x, -this.pos.y), a.strokeStyle = b || "red", a.beginPath(), a.moveTo(this.points[0].x, this.points[0].y), this.points.forEach(function(b) {
				a.lineTo(b.x, b.y), a.moveTo(b.x, b.y)
			}), this.closed === !0 && a.lineTo(this.points[0].x, this.points[0].y), a.stroke(), a.restore()
		}
	})
}(),
function() {
	me.Matrix2d = Object.extend({
		...
		set: function(a, b, c, d, e, f) {
			return this.a = a, this.b = b, this.c = c, this.d = d, this.e = "undefined" != typeof e ? e : this.e, this.f = "undefined" != typeof f ? f : this.f, this
		},
		multiply: function(a, b, c, d, e, f) {
			var g = this.a,
				...
				i = this.c,
				j = this.d;
			return this.a = a * g + b * i, this.b = a * h + b * j, this.c = c * g + d * i, this.d = c * h + d * j, this.e = e * g + f * i + this.e, this.f = e * h + f * j + this.f, this
		},
		scale: function(a, b) {
			return this.a *= a, this.d *= b, this.e *= a, this.f *= b, this
		},
		rotate: function(a) {
			if (0 !== a) {
				var b = Math.cos(a),
					...
					h = this.e,
					i = this.f;
				this.a = d * b - e * c, this.b = d * c + e * b, this.c = f * b - g * c, this.d = f * c + g * b, this.e = h * b - i * c, this.f = h * c + i * b
			}
			return this
		},
		translate: function(a, b) {
			return this.e += a, this.f += b, this
		},
		translateV: function(a) {
			return this.translate(a.x, a.y)
		},
...
function() {
	me.Renderable = me.Rect.extend({
		...
		alpha: 1,
		init: function(a, b, c) {
			this.parent(a, b, c), this.anchorPoint.set(.5, .5), this.setOpacity(1)
		},
		getOpacity: function() {
			return this.alpha
		},
...
function() {
	me.SpriteObject = me.Renderable.extend({
		...
		init: function(a, b, c, d, e) {
			this.isSprite = !0, this.parent(new me.Vector2d(a, b), d || c.width, e || c.height), this.image = c, this.scale.set(1, 1), this.lastflipX = this.lastflipY = !1, this.scaleFlag = !1, this.offset.set(0, 0), this.isPersistent = !1, this.flickering = !1
		},
		setTransparency: function(a) {
			a = "#" === a.charAt(0) ? a.substring(1, 7) : a, this.image = me.video.applyRGBFilter(this.image, "transparent", a.toUpperCase()).canvas
		},
		...
		flipX: function(a) {
			a !== this.lastflipX && (this.lastflipX = a, this.scale.x = -this.scale.x, this.scaleFlag = 1 !== this.scale.x || 1 !== this.scale.y)
		},
		flipY: function(a) {
			a !== this.lastflipY && (this.lastflipY = a, this.scale.y = -this.scale.y, this.scaleFlag = 1 !== this.scale.x || 1 !== this.scale.y)
		},
		resize: function(a, b) {
			var c = a,
				d = "undefined" == typeof b ? a : b;
			c > 0 && (this.scale.x = this.scale.x < 0 ? -c : c), d > 0 && (this.scale.y = this.scale.y < 0 ? -d : d), this.scaleFlag = 1 !== this.scale.x || 1 !== this.scale.y
		},
		resizeV: function(a) {
			this.resize(a.x, a.y)
		},
		...
		draw: function(a) {
			if (!this.flickering || (this.flickerState = !this.flickerState, this.flickerState)) {
				a.save(), a.globalAlpha *= this.getOpacity();
				var b = ~~this.pos.x,
					c = ~~this.pos.y,
					d = this.width,
					e = this.height,
					f = this.angle + this._sourceAngle;
				if (this.scaleFlag || 0 !== f) {
					var g = d * this.anchorPoint.x,
						h = e * this.anchorPoint.y;
					a.translate(b + g, c + h), this.scaleFlag && a.scale(this.scale.x, this.scale.y), 0 !== f && a.rotate(f), 0 !== this._sourceAngle ? (d = this.height, e = this.width, b = -h, c = -g) : (b = -g, c = -h)
				}
		...
		init: function(a, b, c, d, e, f, g, h, i) {
			this.anim = {}, this.resetAnim = null, this.current = null, this.animationspeed = 100, this.spacing = f || 0, this.margin = g || 0, this.parent(a, b, c, d, e, f, g), this.textureAtlas = null, this.atlasIndices = null, this.buildLocalAtlas(h, i), this.addAnimation("default", null), this.setCurrentAnimation("default")
		},
		buildLocalAtlas: function(a, b) {
			if ("undefined" != typeof a) this.textureAtlas = a, this.atlasIndices = b;
			else {
				this.textureAtlas = [];
				for (var c = new me.Vector2d(~~((this.image.width - this.margin) / (this.width + this.spacing)), ~~ ((this.image.height - this.margin) / (this.height + this.spacing))), d = 0, e = c.x * c.y; e > d; d++) this.textureAtlas[d] = {
					name: "" + d,
					offset: new me.Vector2d(this.margin + (this.spacing + this.width) * (d % c.x), this.margin + (this.spacing + this.height) * ~~(d / c.x)),
					width: this.width,
					height: this.height,
					hWidth: this.width / 2,
		...
		addAnimation: function(a, b, c) {
			...
			for (var e = 0, f = b.length; f > e; e++)
				if ("number" == typeof b[e]) this.anim[a].frame[e] = this.textureAtlas[b[e]];
				else {
					if (null === this.atlasIndices) throw "melonjs: string parameters for addAnimation  are only allowed for TextureAtlas ";
		...
		setCurrentAnimation: function(a, b) {
			if (!this.anim[a]) throw "melonJS: animation id '" + a + "' not defined";
		...
		update: function(a) {
			if (!this.animationpause && (this.current.nextFrame -= a, this.current.nextFrame <= 0)) {
				if (this.setAnimationFrame(++this.current.idx), 0 === this.current.idx && this.resetAnim)
					...
					else if ("function" == typeof this.resetAnim && this.resetAnim() === !1) return this.current.idx = this.current.length - 1, this.setAnimationFrame(this.current.idx), this.parent(a), !1;
				return this.current.nextFrame = this.current.animationspeed, this.parent(a) || !0
			}
...
function() {
	...
	me.TextureAtlas = Object.extend({
			...
			if (a && a.meta) {
				if (a.meta.app.contains("texturepacker"))
					if (this.format = "texturepacker", "undefined" == typeof b) {
						...
						if (this.texture = me.loader.getImage(c), null === this.texture) throw "melonjs: Atlas texture '" + c + "' not found"
					} else this.texture = b;
				if (a.meta.app.contains("ShoeBox")) {
					if (!a.meta.exporter || !a.meta.exporter.contains("melonJS")) throw "melonjs: ShoeBox requires the JSON exporter : https://github.com/melonjs/melonJS/tree/master/media/shoebox_JSON_export.sbx";
					this.format = "ShoeBox", this.texture = b
				}
				this.atlas = this.initFromTexturePacker(a)
			}
			if (null === this.atlas) throw "melonjs: texture atlas format not supported"
		},
		initFromTexturePacker: function(a) {
			var b = {};
			return a.frames.forEach(function(a) {
				a.hasOwnProperty("filename") && (b[a.filename] = {
					frame: new me.Rect(new me.Vector2d(a.frame.x, a.frame.y), a.frame.w, a.frame.h),
					source: new me.Rect(new me.Vector2d(a.spriteSourceSize.x, a.spriteSourceSize.y), a.spriteSourceSize.w, a.spriteSourceSize.h),
					rotated: a.rotated === !0,
					trimmed: a.trimmed === !0
				})
			}), b
		...
		createSpriteFromName: function(a) {
			...
			if (b) {
				var c = new me.SpriteObject(0, 0, this.getTexture(), b.width, b.height);
				return c.offset.setV(b.offset), c._sourceAngle = b.angle, c
			}
			throw "melonjs: TextureAtlas - region for " + a + " not found"
		},
		createAnimationFromName: function(a) {
			for (var b = [], c = {}, d = 0; d < a.length; ++d)
				if (b[d] = this.getRegion(a[d]), c[a[d]] = d, null == b[d]) throw "melonjs: TextureAtlas - region for " + a[d] + " not found";
			return new me.AnimationSheet(0, 0, this.texture, 0, 0, 0, 0, b, c)
		}
	})
}(),
function() {
	...
	me.Viewport = me.Renderable.extend({
		...
		init: function(a, b, c, d) {
			this.parent(new me.Vector2d(a, b), c - a, d - b), this.bounds = new me.Rect(new me.Vector2d(-1 / 0, -1 / 0), 1 / 0, 1 / 0), this.offset = new me.Vector2d, this.target = null, this.follow_axis = this.AXIS.NONE, this._shake = {
				intensity: 0,
				duration: 0,
				axis: this.AXIS.BOTH,
				onComplete: null
		...
		setDeadzone: function(a, b) {
			null === this.deadzone && (this.deadzone = new me.Rect(new me.Vector2d, 0, 0)), this.deadzone.pos.set(~~((this.width - a) / 2), ~~ ((this.height - b) / 2 - .25 * b)), this.deadzone.resize(a, b), this.updateTarget()
		},
		setBounds: function(a, b, c, d) {
			this.bounds.pos.set(a, b), this.bounds.resize(c, d)
		},
		follow: function(a, b) {
			if (this.target = "object" == typeof a.pos ? a.pos : a, "undefined" == typeof this.target.x || "undefined" == typeof this.target.y) throw "melonJS: invalid target for viewport.follow";
		...
		fadeOut: function(a, b, c) {
			this._fadeOut.color = me.pool.pull("me.Color").parseHex(a), this._fadeOut.color.alpha = 1, this._fadeOut.duration = b || 1e3, this._fadeOut.tween = me.pool.pull("me.Tween", this._fadeOut.color).to({
				alpha: 0
			}, this._fadeOut.duration).onComplete(c || null), this._fadeOut.tween.start()
		},
		fadeIn: function(a, b, c) {
			this._fadeIn.color = me.pool.pull("me.Color").parseHex(a), this._fadeIn.color.alpha = 0, this._fadeIn.duration = b || 1e3, this._fadeIn.tween = me.pool.pull("me.Tween", this._fadeIn.color).to({
				alpha: 1
		...
		focusOn: function(a) {
			var b = a.getBounds();
			this.moveTo(a.pos.x + b.pos.x + b.hWidth, a.pos.y + b.pos.y + b.hHeight)
		},
		...
		draw: function(a) {
			this._fadeIn.tween && (me.video.clearSurface(a, this._fadeIn.color.toRGBA()), 1 === this._fadeIn.color.alpha && (this._fadeIn.tween = null, me.pool.push(this._fadeIn.color), this._fadeIn.color = null)), this._fadeOut.tween && (me.video.clearSurface(a, this._fadeOut.color.toRGBA()), 0 === this._fadeOut.color.alpha && (this._fadeOut.tween = null, me.pool.push(this._fadeOut.color), this._fadeOut.color = null))
		}
	})
}(),
function() {
	me.GUI_Object = me.SpriteObject.extend({
		...
		released: !0,
		init: function(a, b, c) {
			this.parent(a, b, "string" == typeof c.image ? me.loader.getImage(c.image) : c.image, c.spritewidth, c.spriteheight), this.floating = !0, me.input.registerPointerEvent("pointerdown", this, this.clicked.bind(this)), me.input.registerPointerEvent("pointerup", this, this.release.bind(this))
		},
		update: function() {
...
function() {
	var a = function(a, b) {
		...
		b = new me.Rect(new me.Vector2d, 0, 0),
		c = 0;
	me.ObjectContainer = me.Renderable.extend({
		...
		init: function(a, b, c, d) {
			this.parent(new me.Vector2d(a || 0, b || 0), c || 1 / 0, d || 1 / 0), this.bounds = new me.Rect(new me.Vector2d(0, 0), 0, 0), this.children = [], this.sortOn = me.game.sortOn, this.autoSort = !0, this.transform.identity()
		},
		addChild: function(a, b) {
			"undefined" != typeof a.ancestor ? a.ancestor.removeChildNow(a) : a.isRenderable && (a.GUID = me.utils.createGUID()), "number" == typeof b && (a.z = b), "undefined" == typeof a.z && (a.z = this.children.length), a.ancestor = this, this.children.push(a), this.autoSort === !0 && this.sort()
		},
		addChildAt: function(a, b) {
			if (!(b >= 0 && b < this.children.length)) throw "melonJS (me.ObjectContainer): Index (" + b + ") Out Of Bounds for addChildAt()";
			"undefined" != typeof a.ancestor ? a.ancestor.removeChildNow(a) : a.isRenderable && (a.GUID = me.utils.createGUID()), a.ancestor = this, this.children.splice(b, 0, a)
		},
		swapChildren: function(a, b) {
			var c = this.getChildIndex(a),
				d = this.getChildIndex(b);
			if (-1 === c || -1 === d) throw "melonJS (me.ObjectContainer): " + a + " Both the supplied childs must be a child of the caller " + this;
			var e = a.z;
			a.z = b.z, b.z = e, this.children[c] = b, this.children[d] = a
		},
		getChildAt: function(a) {
			if (a >= 0 && a < this.children.length) return this.children[a];
			throw "melonJS (me.ObjectContainer): Index (" + a + ") Out Of Bounds for getChildAt()"
		},
		...
		getChildByProp: function(a, b) {
			function c(a, c) {
				"string" == typeof a[c] ? a[c].match(f) && e.push(a) : a[c] === b && e.push(a)
			}
			for (var d, e = [], f = new RegExp(b, "i"), g = this.children.length; g--, d = this.children[g];) d instanceof me.ObjectContainer ? (c(d, a), e = e.concat(d.getChildByProp(a, b))) : c(d, a);
			return e
		},
		...
		getBounds: function(a) {
			var b = "undefined" != typeof a ? a : this.bounds;
			b.pos.set(1 / 0, 1 / 0), b.resize(-1 / 0, -1 / 0);
			for (var c, d, e = this.children.length; e--, d = this.children[e];) d.isRenderable && (c = d.getBounds(), null !== c && b.union(c));
			return b
		},
		...
		removeChildNow: function(a, b) {
			if (!this.hasChild(a)) throw "melonJS (me.ObjectContainer): " + a + " The supplied child must be a child of the caller " + this;
			a.ancestor = void 0, b || ("function" == typeof a.destroy && a.destroy(), me.pool.push(a)), this.children.splice(this.getChildIndex(a), 1)
		},
		setChildsProperty: function(a, b, c) {
			for (var d, e = this.children.length; e--, d = this.children[e];) c === !0 && d instanceof me.ObjectContainer && d.setChildsProperty(a, b, c), d[a] = b
		},
		moveUp: function(a) {
		...
		collide: function(a, b) {
			return this.collideType(a, null, b)
		},
		collideType: function(a, b, c) {
			var d, e;
			c = c === !0 ? !0 : !1, c === !0 && (e = []);
			for (var f, g = this.children.length; g--, f = this.children[g];)
				if ((f.inViewport || f.alwaysUpdate) && f.collidable)
					if (f instanceof me.ObjectContainer) {
						if (d = f.collideType(a, b, c), c) e.concat(d);
						else if (d) return d
					} else if (f !== a && (!b || f.type === b) && (this._boundsA = f.getBounds(this._boundsA).translateV(f.pos), this._boundsB = a.getBounds(this._boundsB).translateV(a.pos), d = this._boundsA["collideWith" + this._boundsB.shapeType].call(this._boundsA, this._boundsB), 0 !== d.x || 0 !== d.y)) {
				if (f.onCollision.call(f, d, a), d.type = f.type, d.obj = f, !c) return d;
				e.push(d)
			}
			return c ? e : null
		},
		sort: function(a) {
			if (null === this.pendingSort) {
				if (a === !0)
					for (var b, c = this.children.length; c--, b = this.children[c];) b instanceof me.ObjectContainer && b.sort(a);
		...
		update: function(a) {
			for (var d, e, f, g, h = !1, i = !1, j = me.state.isPaused(), k = me.game.viewport, l = this.children.length; l--, g = this.children[l];)(!j || g.updateWhenPaused) && (g.isRenderable ? (i = c > 0 || g.floating, i && c++, d = !i, d && (e = g.pos.x, f = g.pos.y, b.translateV(g.pos), b.resize(g.width, g.height)), g.inViewport = i || k.isVisible(b), h |= (g.inViewport || g.alwaysUpdate) && g.update(a), d && b.translate(-e, -f), c > 0 && c--) : h |= g.update(a));
			return h
		},
		draw: function(a, b) {
			var c = me.game.viewport,
				d = !1;
			this.drawCount = 0, a.save(), a.transform(this.transform.a, this.transform.b, this.transform.c, this.transform.d, this.transform.e, this.transform.f), a.globalAlpha *= this.getOpacity(), a.translate(this.pos.x, this.pos.y);
			for (var e, f = this.children.length; f--, e = this.children[f];) d = e.floating, (e.inViewport || d) && e.isRenderable && (d === !0 && (a.save(), a.translate(c.screenX - this.pos.x, c.screenY - this.pos.y)), e.draw(a, b), d === !0 && a.restore(), this.drawCount++);
			a.restore()
		}
	})
}(),
function() {
	me.ObjectSettings = {
		...
		lastflipY: !1,
		init: function(a, b, c) {
			if ("number" != typeof c.width || "number" != typeof c.height) throw "melonjs: height and width properties are mandatory when passing settings parameters to an object entity";
			if (this.parent(this.pos.set(a, b), c.width, c.height), c.image) {
				var d = "object" == typeof c.image ? c.image : me.loader.getImage(c.image);
				this.renderable = new me.AnimationSheet(0, 0, d, ~~ (c.spritewidth || c.width), ~~ (c.spriteheight || c.height), ~~c.spacing, ~~c.margin), c.transparent_color && this.renderable.setTransparency(c.transparent_color)
			}
			this.name = c.name ? c.name.toLowerCase() : "", "undefined" == typeof this.vel && (this.vel = new me.Vector2d), this.vel.set(0, 0), "undefined" == typeof this.accel && (this.accel = new me.Vector2d), this.accel.set(0, 0), "undefined" == typeof this.friction && (this.friction = new me.Vector2d), this.friction.set(0, 0), "undefined" == typeof this.maxVel && (this.maxVel = new me.Vector2d), this.maxVel.set(1e3, 1e3), this.gravity = "undefined" != typeof me.sys.gravity ? me.sys.gravity : .98, this.alive = !0, this.falling = !1, this.jumping = !0, this.slopeY = 0, this.onslope = !1, this.onladder = !1, this.disableTopLadderCollision = !1, this.collidable = "undefined" != typeof c.collidable ? c.collidable : !0, this.type = c.type || 0, this.lastflipX = this.lastflipY = !1, this.collisionMap = me.game.collisionMap, this.canBreakTile = !1, this.onTileBreak = null, "function" == typeof c.getShape && (this.addShape(c.getShape()), "PolyShape" === this.getShape().shapeType && (this._bounds = this.getBounds(), this.resize(this._bounds.width, this._bounds.height)))
		},
		addShape: function(a) {
			this.shapes.push(a)
		},
		...
		setShape: function(a) {
			if ("undefined" != typeof this.shapes[a]) return void(this.shapeIndex = a);
			throw "melonJS (me.Entity): Shape (" + a + ") not defined"
		},
		onCollision: function() {
			this.collidable && this.type === me.game.COLLECTABLE_OBJECT && me.game.world.removeChild(this)
		},
		...
		flipX: function(a) {
			a !== this.lastflipX && (this.lastflipX = a, this.renderable && this.renderable.flipX && this.renderable.flipX(a), this.shapes.length && "function" == typeof this.getShape().flipX && this.getShape().flipX(this.width))
		},
		flipY: function(a) {
			a !== this.lastflipY && (this.lastflipY = a, this.renderable && this.renderable.flipY && this.renderable.flipY(a), this.shapes.length && "function" == typeof this.getShape().flipY && this.getShape().flipY(this.height))
		},
		distanceTo: function(a) {
			var b = this.pos.x + this.hWidth - (a.pos.x + a.hWidth),
				c = this.pos.y + this.hHeight - (a.pos.y + a.hHeight);
			return Math.sqrt(b * b + c * c)
		},
		distanceToPoint: function(a) {
			var b = this.pos.x + this.hWidth - a.x,
				c = this.pos.y + this.hHeight - a.y;
			return Math.sqrt(b * b + c * c)
		},
		angleTo: function(a) {
			var b = a.pos.x + a.hWidth - (this.pos.x + this.hWidth),
				c = a.pos.y + a.hHeight - (this.pos.y + this.hHeight);
			return Math.atan2(c, b)
		},
		angleToPoint: function(a) {
			var b = a.x - (this.pos.x + this.hWidth),
				c = a.y - (this.pos.y + this.hHeight);
			return Math.atan2(c, b)
		},
		checkSlope: function(a, b, c) {
			a.pos.y = b.pos.y - a.height, this.slopeY = c ? b.height - (a.right + this.vel.x - b.pos.x) : a.left + this.vel.x - b.pos.x, this.vel.y = 0, a.pos.y += this.slopeY.clamp(0, b.height)
		},
		computeVelocity: function(a) {
			this.gravity && (a.y += this.onladder ? 0 : this.gravity * me.timer.tick, this.falling = a.y > 0, this.jumping = this.falling ? !1 : this.jumping), this.friction.x && (a.x = me.utils.applyFriction(a.x, this.friction.x)), this.friction.y && (a.y = me.utils.applyFriction(a.y, this.friction.y)), 0 !== a.y && (a.y = a.y.clamp(-this.maxVel.y, this.maxVel.y)), 0 !== a.x && (a.x = a.x.clamp(-this.maxVel.x, this.maxVel.x))
		},
		updateMovement: function() {
			this.computeVelocity(this.vel);
			var a;
			if (this.collidable) {
				this._bounds = this.getBounds(this._bounds), this.__offsetX = this._bounds.pos.x, this.__offsetY = this._bounds.pos.y, this._bounds.translateV(this.pos), a = this.collisionMap.checkCollision(this._bounds, this.vel), this.onslope = a.yprop.isSlope || a.xprop.isSlope, this.onladder = !1;
				var b = a.yprop,
					c = a.ytile;
				a.y && (this.onladder = b.isLadder || b.isTopLadder, a.y > 0 ? b.isSolid || b.isPlatform && this._bounds.bottom - 1 <= c.pos.y || b.isTopLadder && !this.disableTopLadderCollision ? (this._bounds.pos.y = ~~this._bounds.pos.y, this.vel.y = this.falling ? c.pos.y - this._bounds.bottom : 0, this.falling = !1) : b.isSlope && !this.jumping ? (this.checkSlope(this._bounds, c, b.isLeftSlope), this.falling = !1) : b.isBreakable && (this.canBreakTile ? (me.game.currentLevel.clearTile(c.col, c.row), this.onTileBreak && this.onTileBreak()) : (this._bounds.pos.y = ~~this._bounds.pos.y, this.vel.y = this.falling ? c.pos.y - this._bounds.bottom : 0, this.falling = !1)) : a.y < 0 && (b.isPlatform || b.isLadder || b.isTopLadder || (this.gravity && (this.falling = !0), this.vel.y = 0))), b = a.xprop, c = a.xtile, a.x && (this.onladder = b.isLadder || b.isTopLadder, b.isSlope && !this.jumping ? (this.checkSlope(this._bounds, c, b.isLeftSlope), this.falling = !1) : b.isPlatform || b.isLadder || b.isTopLadder || (b.isBreakable && this.canBreakTile ? (me.game.currentLevel.clearTile(c.col, c.row), this.onTileBreak && this.onTileBreak()) : this.vel.x = 0)), this.pos.set(this._bounds.pos.x - this.__offsetX, this._bounds.pos.y - this.__offsetY)
			}
			return this.pos.add(this.vel), a
		},
		update: function(a) {
			return this.renderable ? this.renderable.update(a) : !1
		},
		getBounds: function(a) {
			return this.shapes.length || this.addShape(this.parent().translate(-this.pos.x, -this.pos.y)), this.getShape().getBounds(a)
		},
		draw: function(a) {
			if (this.renderable) {
				var b = this;
				this.shapes.length && "PolyShape" === this.getShape().shapeType && (b = this.getBounds(this._bounds).translateV(this.pos));
				var c = ~~ (b.pos.x + this.anchorPoint.x * (b.width - this.renderable.width)),
					d = ~~ (b.pos.y + this.anchorPoint.y * (b.height - this.renderable.height));
				a.translate(c, d), this.renderable.draw(a), a.translate(-c, -d)
			}
		},
		destroy: function() {
			this.renderable && (this.renderable.destroy.apply(this.renderable, arguments), this.renderable = null), this.onDestroyEvent.apply(this, arguments), this.shapes = [], this.shapeIndex = 0
		},
		onDestroyEvent: function() {}
	}), me.CollectableEntity = me.ObjectEntity.extend({
		init: function(a, b, c) {
			this.parent(a, b, c), this.type = me.game.COLLECTABLE_OBJECT
		}
	}), me.LevelEntity = me.ObjectEntity.extend({
		init: function(a, b, c) {
			this.parent(a, b, c), this.nextlevel = c.to, this.fade = c.fade, this.duration = c.duration, this.fading = !1, this.gotolevel = c.to
		},
...
function() {
	...
	function() {
		var a = 0,
			b = me.agent.prefixed("requestAnimationFrame"),
			c = me.agent.prefixed("cancelAnimationFrame") || me.agent.prefixed("cancelRequestAnimationFrame");
		b && c || (b = function(b) {
		...
		}), window.requestAnimationFrame = b, window.cancelAnimationFrame = c
	}(), me.state = function() {
		function a() {
		...
		return g.LOADING = 0, g.MENU = 1, g.READY = 2, g.PLAY = 3, g.GAMEOVER = 4, g.GAME_END = 5, g.SCORE = 6, g.CREDITS = 7, g.SETTINGS = 8, g.USER = 100, g.onPause = null, g.onResume = null, g.onStop = null, g.onRestart = null, g.init = function() {
			...
			if ("undefined" == typeof k[a]) throw "melonJS : Undefined ScreenObject for state '" + a + "'";
...
function() {
	...
	me.DefaultLoadingScreen = me.ScreenObject.extend({
		onResetEvent: function() {
			...
			var d = new a(new me.Vector2d, me.video.getWidth(), me.video.getHeight());
			this.handle = me.event.subscribe(me.event.LOADER_PROGRESS, d.onProgressUpdate.bind(d)), me.game.world.addChild(d, 1);
			var e = new b((me.video.getWidth() - 100) / 2, me.video.getHeight() / 2 - d.barHeight / 2 - 90);
			me.game.world.addChild(e, 1), me.game.world.addChild(new c(me.video.getWidth(), me.video.getHeight()), 1)
		},
		onDestroyEvent: function() {
	...
	me.loader = function() {
		...
		function c(a, b, c) {
			...
			var e = new XMLHttpRequest,
				g = me.utils.getFileExtension(a.src).toLowerCase();
				...
				if (4 === e.readyState)
					if (200 === e.status || 0 === e.status && e.responseText) {
						...
						switch (g) {
							case "xml":
							case "tmx":
								a = me.device.ua.match(/msie/i) || !e.responseXML ? (new DOMParser).parseFromString(e.responseText, "text/xml") : e.responseXML, a = me.TMXUtils.parse(a).map, g = "json";
								break;
							case "json":
								a = JSON.parse(e.responseText);
								break;
							default:
								throw "melonJS: TMX file format " + g + "not supported !"
						}
						d(a, g), b()
					} else c()
			}, e.send(null)
		...
		var f = {},
			...
			l = 0,
			m = 0;
		return f.nocache = "", f.onload = void 0, f.onProgress = void 0, f.onResourceLoaded = function(a) {
			l++;
			...
			f.nocache = a ? "?" + parseInt(1e7 * Math.random(), 10) : ""
		}, f.preload = function(b) {
			for (var c = 0; c < b.length; c++) k += f.load(b[c], f.onResourceLoaded.bind(f, b[c]), f.onLoadingError.bind(f, b[c]));
			a()
		}, f.load = function(a, f, g) {
			switch (a.name = a.name.toLowerCase(), a.type) {
				case "binary":
					return e.call(this, a, f, g), 1;
				case "image":
					return b.call(this, a, f, g), 1;
				case "json":
					return d.call(this, a, f, g), 1;
				case "tmx":
				case "tsx":
					return c.call(this, a, f, g), 1;
				case "audio":
					return me.audio.load(a, f, g), 1;
				default:
					throw "melonJS: me.loader.load : unknown or invalid resource type : " + a.type
			}
			return 0
		}, f.unload = function(a) {
			switch (a.name = a.name.toLowerCase(), a.type) {
				...
				default:
					throw "melonJS: me.loader.unload : unknown or invalid resource type : " + a.type
			}
...
function() {
	me.Font = me.Renderable.extend({
		...
		lineHeight: 1,
		init: function(a, b, c, d) {
			this.setFont(a, b, c, d), this.parent(this.pos, 0, this.fontSize.y)
		},
		bold: function() {
		...
		setFont: function(a, b, c, d) {
			...
			this.fontSize.y = parseInt(b, 10), this.height = this.fontSize.y, "number" == typeof b && (b += "px"), this.font = b + " " + e.join(","), this.fillStyle = c, d && (this.textAlign = d)
		},
		...
		draw: function(a, b, c, d) {
			this.pos.set(c, d), a.font = this.font, a.fillStyle = this.fillStyle, a.textAlign = this.textAlign, a.textBaseline = this.textBaseline;
			for (var e = ("" + b).split("\n"), f = 0; f < e.length; f++) a.fillText(e[f].trimRight(), ~~c, ~~d), d += this.fontSize.y * this.lineHeight
		},
		drawStroke: function(a, b, c, d) {
			this.pos.set(c, d), a.font = this.font, a.fillStyle = this.fillStyle, a.strokeStyle = this.strokeStyle, a.lineWidth = this.lineWidth, a.textAlign = this.textAlign, a.textBaseline = this.textBaseline;
			for (var e = ("" + b).split("\n"), f = 0; f < e.length; f++) {
				var g = e[f].trimRight();
				a.strokeText(g, ~~c, ~~d), a.fillText(g, ~~c, ~~d), d += this.fontSize.y * this.lineHeight
			}
		}
	})
}(),
function() {
	me.BitmapFont = me.Font.extend({
		...
		charCount: 0,
		init: function(a, b, c, d) {
			this.parent(a, null, null), this.firstChar = d || 32, this.loadFontMetrics(a, b), this.textAlign = "left", this.textBaseline = "top", c && this.resize(c)
		},
		...
		draw: function(a, b, c, d) {
			var e = ("" + b).split("\n"),
				...
				h = a.globalAlpha;
			a.globalAlpha *= this.getOpacity(), this.pos.set(c, d);
...
function() {
	me.audio = function() {
		function a(a, b) {
			if (h++ > 3) {
				var c = "melonJS: failed loading " + a;
				if (me.sys.stopOnAudioError !== !1) throw c;
				me.audio.disable(), b && b(), console.log(c + ", disabling audio")
			} else d[a].load()
		}
		...
		return c.init = function(a) {
			if (!me.initialized) throw "melonJS: me.audio.init() called before engine initialization.";
			a = "string" == typeof a ? a : "mp3", this.audioFormats = a.split(",")
		}, c.enable = function() {
			this.unmuteAll()
		}, c.disable = function() {
			this.muteAll()
		}, c.load = function(b, c, f) {
			var g = [];
			if ("undefined" == typeof this.audioFormats || 0 === this.audioFormats.length) throw "melonJS: target audio extension(s) should be set through me.audio.init() before calling the preloader.";
			for (var i = 0; i < this.audioFormats.length; i++) g.push(b.src + b.name + "." + this.audioFormats[i] + me.loader.nocache);
			var j = new Howl({
				urls: g,
			...
			return d[b.name] = j, 1
		}, c.play = function(a, b, c, e) {
			var f = d[a.toLowerCase()];
			return f && "undefined" != typeof f ? (f.loop(b || !1), f.volume("number" == typeof e ? e.clamp(0, 1) : Howler.volume()), f.play(null, c), f) : void 0
		}, c.stop = function(a, b) {
			var c = d[a.toLowerCase()];
			c && "undefined" != typeof c && c.stop(b)
		}, c.pause = function(a, b) {
			var c = d[a.toLowerCase()];
			c && "undefined" != typeof c && c.pause(b)
		}, c.playTrack = function(a, c) {
			return f = a.toLowerCase(), me.audio.play(f, !0, navigator.isCocoonJS && !Howler.usingWebAudio ? b : void 0, c)
		}, c.stopTrack = function() {
			null !== f && (d[f].stop(navigator.isCocoonJS && !Howler.usingWebAudio ? g : void 0), f = null)
		}, c.pauseTrack = function() {
			null !== f && d[f].pause(navigator.isCocoonJS && !Howler.usingWebAudio ? g : void 0)
		}, c.resumeTrack = function() {
			null !== f && d[f].play(null, navigator.isCocoonJS && !Howler.usingWebAudio ? b : void 0)
			...
			var c = d[a.toLowerCase()];
			c && "undefined" != typeof c && c.mute(!0)
		}, c.unmute = function(a) {
			c.mute(a, !1)
		}, c.muteAll = function() {
			Howler.mute()
		}, c.unmuteAll = function() {
			Howler.unmute()
		}, c.unload = function(a) {
			return a = a.toLowerCase(), a in d ? (d[a].unload(), delete d[a], !0) : !1
		}, c.unloadAll = function() {
			for (var a in d) d.hasOwnProperty(a) && c.unload(a)
		}, c
	}()
}(),
function() {
	me.video = function() {
		var a = {},
			...
			m = 1 / 0,
			n = 1 / 0;
		return a.init = function(g, m, n, o, p, q) {
			if (!me.initialized) throw "melonJS: me.video.init() called before engine initialization.";
			if (h = o || !1, k = "auto" === p || !1, l = "undefined" != typeof q ? q : !0, p = "auto" !== p ? parseFloat(p || 1) : 1, me.sys.scale = new me.Vector2d(p, p), (k || 1 !== p) && (h = !0), i = m * me.sys.scale.x, j = n * me.sys.scale.y, window.addEventListener("resize", throttle(100, !1, function(a) {
			...
			}, !1), me.event.subscribe(me.event.WINDOW_ONRESIZE, me.video.onresize.bind(me.video)), me.event.subscribe(me.event.WINDOW_ONORIENTATION_CHANGE, me.video.onresize.bind(me.video)), b = a.createCanvas(i, j, !0), g && (f = document.getElementById(g)), f || (f = document.body), f.appendChild(b), !b.getContext) return !1;
			if (c = a.getContext2d(b), me.device.getPixelRatio() > 1 && (b.style.width = b.width / me.device.getPixelRatio() + "px", b.style.height = b.height / me.device.getPixelRatio() + "px"), h ? (d = a.createCanvas(m, n, !1), e = a.getContext2d(d)) : (d = b, e = c), window.getComputedStyle) {
				var r = window.getComputedStyle(b, null);
				me.video.setMaxSize(parseInt(r.maxWidth, 10), parseInt(r.maxHeight, 10))
			}
			return me.video.onresize(null), me.game.init(), !0
		}, a.getWrapper = function() {
			return f
		}, a.getWidth = function() {
			return d.width
		}, a.getPos = function(a) {
			return a = a || b, a.getBoundingClientRect ? a.getBoundingClientRect() : {
				left: 0,
				top: 0
			}
		}, a.getHeight = function() {
			return d.height
		}, a.setMaxSize = function(a, b) {
			m = a || 1 / 0, n = b || 1 / 0
		}, a.createCanvas = function(a, b, c) {
			if (0 === a || 0 === b) throw new Error("melonJS: width or height was zero, Canvas could not be initialized !");
			var e = document.createElement("canvas");
			return c === !0 && navigator.isCocoonJS && me.device.android2 !== !0 && (e.screencanvas = !0), e.width = a || d.width, e.height = b || d.height, e
		}, a.getContext2d = function(a) {
			var b;
			return b = navigator.isCocoonJS ? a.getContext("2d", {
				antialias: me.sys.scalingInterpolation
			}) : a.getContext("2d"), b.canvas || (b.canvas = a), me.video.setImageSmoothing(b, me.sys.scalingInterpolation), b
		}, a.getScreenCanvas = function() {
			return b
		}, a.getScreenContext = function() {
			return c
		}, a.getSystemCanvas = function() {
			return d
		}, a.getSystemContext = function() {
			return e
		}, a.onresize = function() {
			var a = 1,
				b = 1;
			if (me.device.orientation = "undefined" != typeof window.orientation ? window.orientation : window.outerWidth > window.outerHeight ? 90 : 0, k) {
				var c = me.video.getScreenCanvas().parentNode,
					d = Math.min(m, c.width || window.innerWidth),
					e = Math.min(n, c.height || window.innerHeight);
				if (l) {
					var f = me.video.getWidth() / me.video.getHeight(),
						h = d / e;
					a = b = f > h ? d / me.video.getWidth() : e / me.video.getHeight()
				} else a = d / me.video.getWidth(), b = e / me.video.getHeight(); if (a *= me.device.getPixelRatio(), b *= me.device.getPixelRatio(), 1 !== a || 1 !== b) return g >= 0 && clearTimeout(g), void(g = me.video.updateDisplaySize.defer(this, a, b))
			}
			me.input._offset = me.video.getPos()
		}, a.updateDisplaySize = function(e, f) {
			me.sys.scale.set(e, f), b.width = i = d.width * e, b.height = j = d.height * f, me.device.getPixelRatio() > 1 && (b.style.width = b.width / me.device.getPixelRatio() + "px", b.style.height = b.height / me.device.getPixelRatio() + "px"), me.video.setImageSmoothing(c, me.sys.scalingInterpolation), me.input._offset = me.video.getPos(), a.blitSurface(), g = -1
		}, a.clearSurface = function(a, b) {
			var c = a.canvas;
			a.save(), a.setTransform(1, 0, 0, 1, 0, 0), a.fillStyle = b, a.fillRect(0, 0, c.width, c.height), a.restore()
			...
			a.blitSurface = h ? function() {
				c.drawImage(d, 0, 0, d.width, d.height, 0, 0, i, j)
			} : function() {}, a.blitSurface()
		}, a.applyRGBFilter = function(b, c, d) {
			var e, f, g = a.getContext2d(a.createCanvas(b.width, b.height, !1)),
				h = me.utils.getPixels(b),
				i = h.data;
			switch (c) {
				case "b&w":
				...
				case "brightness":
					...
					break;
				case "transparent":
					var l = me.pool.pull("me.Color").parseHex(d),
						m = me.pool.pull("me.Color");
...
function() {
	function a(a, b) {
		for (var c = 2; c < a.length; ++c) "undefined" != typeof a[c] && me.video.getScreenCanvas().addEventListener(a[c], b, !1)
	}
	...
	function b() {
		...
		}), !1), m = navigator.pointerEnabled ? n : navigator.msPointerEnabled ? o : me.device.touch ? q : p, a(m, g), k = "onwheel" in document.createElement("div") ? "wheel" : "mousewheel", window.addEventListener(k, e, !1), "undefined" == typeof h.throttlingInterval && (h.throttlingInterval = Math.floor(1e3 / me.sys.fps)), h.throttlingInterval < 17 ? me.video.getScreenCanvas().addEventListener(m[r], f, !1) : me.video.getScreenCanvas().addEventListener(m[r], throttle(h.throttlingInterval, !1, function(a) {
			f(a)
		}), !1), j = !0)
	}
	...
	function c(a) {
		...
		if (c || (c = m.indexOf(a.type) === u ? i[m[t]] : i[a.type]), c) {
			...
			for (var d = 0, e = w.length; e > d; d++) {
				...
				for (var f, g = c.length; g--, f = c[g];)
					if (f.floating === !0 ? (a.gameX = a.gameScreenX, a.gameY = a.gameScreenY) : (a.gameX = a.gameWorldX, a.gameY = a.gameWorldY), f.bounds.containsPoint(a.gameX - f.rect.pos.x, a.gameY - f.rect.pos.y) && f.cb(a) === !1) {
						b = !0;
						break
					}
			}
	...
	function e(a) {
		if (a.target === me.video.getScreenCanvas()) {
			var b = {
				deltaMode: 1,
				type: "mousewheel",
				deltaX: a.deltaX,
	...
	var h = me.input,
		...
		l = 0,
		m = null,
		n = ["mousewheel", "pointermove", "pointerdown", "pointerup", "pointercancel", void 0, void 0],
		o = ["mousewheel", "MSPointerMove", "MSPointerDown", "MSPointerUp", "MSPointerCancel", void 0, void 0],
		p = ["mousewheel", "mousemove", "mousedown", "mouseup", void 0, void 0, void 0],
		q = [void 0, "touchmove", "touchstart", "touchend", "touchcancel", void 0, void 0],
		r = 1,
		s = 2,
		t = 3,
		u = 4,
	...
	h._offset = null, h.mouse = {
		...
		var a = arguments.length < 2 ? h.mouse.LEFT : arguments[0],
			c = arguments.length < 2 ? arguments[0] : arguments[1];
		if (b(), !h._KeyBinding[c]) throw "melonJS : no action defined for keycode " + c;
		h.mouse.bind[a] = c
		...
		if (b(), -1 === n.indexOf(a)) throw "melonJS : invalid event type : " + a;
		n !== m && (a = m[n.indexOf(a)]), i[a] || (i[a] = []);
		var f = c.floating === !0 ? !0 : !1;
		e && (f = e === !0 ? !0 : !1);
		var g = c.getBounds();
		"undefined" == typeof c.getShape && g.translate(-c.pos.x, -c.pos.y), i[a].push({
			rect: c,
			bounds: g,
			cb: d,
			floating: f
		...
		if (-1 === n.indexOf(a)) throw "melonJS : invalid event type : " + a;
		n !== m && (a = m[n.indexOf(a)]), i[a] || (i[a] = []);
		var c = i[a];
		if (c)
			for (var d, e = c.length; e--, d = c[e];) d.rect === b && (d.rect = d.bounds = d.cb = d.floating = null, i[a].splice(e, 1))
...
function() {
	...
	me.utils = function() {
		...
		return b.decodeBase64 = function(b) {
			...
			c = c || 1;
			var d, e, f, g, h = a.decode(b);
			for (g = "function" == typeof window.Uint32Array ? new Uint32Array(h.length / c) : [], d = 0, f = h.length / c; f > d; d++)
				for (g[d] = 0, e = c - 1; e >= 0; --e) g[d] += h.charCodeAt(d * c + e) << (e << 3);
			return g
			...
			if (a instanceof HTMLImageElement) {
				var b = me.video.getContext2d(me.video.createCanvas(a.width, a.height));
...
function() {
	...
	me.Color = Object.extend({
		...
		alpha: 1,
		init: function(a, b, c, d) {
			return this.onResetEvent(a, b, c, d)
		},
		onResetEvent: function(a, b, c, d) {
			return this.setColor(a, b, c, d)
		},
		setColor: function(a, b, c, d) {
			return this.r = Math.floor(a || 0).clamp(0, 255), this.g = Math.floor(b || 0).clamp(0, 255), this.b = Math.floor(c || 0).clamp(0, 255), this.alpha = "undefined" == typeof d ? 1 : d.clamp(0, 1), this
		},
		clone: function() {
			...
			c = function(b, c) {
				if (c.attributes && c.attributes.length > 0)
					for (var d = 0; d < c.attributes.length; d++) {
						...
						"undefined" != typeof e.name ? b[e.name] = a(e.value) : b[e.nodeName] = a(e.nodeValue)
					}
			};
		return b.parse = function(a, b) {
			var d = {},
				e = "";
			if (b = b || 1, 1 === a.nodeType && c(d, a), a.hasChildNodes()) {
				for (var f = 0; f < a.childNodes.length; f++) {
					...
					if ("undefined" == typeof d[h])
						if (3 === g.nodeType) {
							...
							i && i.length > 0 && (e += i)
						} else 1 === g.nodeType && (d[h] = me.TMXUtils.parse(g, b), d[h]._draworder = b++);
					else Array.isArray(d[h]) === !1 && (d[h] = [d[h]]), d[h].push(me.TMXUtils.parse(g, b)), d[h][d[h].length - 1]._draworder = b++
				}
				e.length > 0 && (d.value = e, e = "")
			}
			return d
		}, b.applyTMXProperties = function(b, c) {
			var d = c[me.TMX_TAG_PROPERTIES];
			if ("undefined" != typeof d)
				if ("undefined" != typeof d.property) {
					var e = d.property;
					Array.isArray(e) === !0 ? e.forEach(function(a) {
						b[a.name] = a.value
					}) : b[e.name] = e.value
				} else
					for (var f in d) d.hasOwnProperty(f) && (b[f] = a(d[f]))
		}, b
	}()
}(),
function() {
	me.TMXObjectGroup = Object.extend({
		...
		init: function(a, b, c, d) {
			var e = this;
			this.name = a, this.width = b[me.TMX_TAG_WIDTH], this.height = b[me.TMX_TAG_HEIGHT], this.z = d, this.objects = [];
			var f = "undefined" != typeof b[me.TMX_TAG_VISIBLE] ? b[me.TMX_TAG_VISIBLE] : !0;
			this.opacity = f === !0 ? parseFloat(b[me.TMX_TAG_OPACITY] || 1).clamp(0, 1) : 0, me.TMXUtils.applyTMXProperties(this, b);
			var g = b.objects || b.object;
			Array.isArray(g) === !0 ? g.forEach(function(a) {
				e.objects.push(new me.TMXObject(a, c, d))
			}) : e.objects.push(new me.TMXObject(g, c, d))
		},
		destroy: function() {
			this.objects = null
		},
		...
		points: void 0,
		init: function(a, b, c) {
			if (this.name = a[me.TMX_TAG_NAME], this.x = parseInt(a[me.TMX_TAG_X], 10), this.y = parseInt(a[me.TMX_TAG_Y], 10), this.z = parseInt(c, 10), this.width = parseInt(a[me.TMX_TAG_WIDTH] || 0, 10), this.height = parseInt(a[me.TMX_TAG_HEIGHT] || 0, 10), this.gid = parseInt(a[me.TMX_TAG_GID], 10) || null, this.type = a[me.TMX_TAG_TYPE], this.isEllipse = !1, this.isPolygon = !1, this.isPolyline = !1, this.gid) this.setImage(this.gid, b);
			else if ("undefined" != typeof a[me.TMX_TAG_ELLIPSE]) this.isEllipse = !0;
			else {
				var d = a[me.TMX_TAG_POLYGON];
				if ("undefined" != typeof d ? this.isPolygon = !0 : (d = a[me.TMX_TAG_POLYLINE], "undefined" != typeof d && (this.isPolyline = !0)), "undefined" != typeof d)
					if (this.points = [], "undefined" != typeof d.points) {
						d = d.points.split(" ");
						for (var e, f = 0; f < d.length; f++) e = d[f].split(","), this.points.push(new me.Vector2d(+e[0], +e[1]))
					} else {
						var g = this;
						d.forEach(function(a) {
							g.points.push(new me.Vector2d(parseInt(a.x, 10), parseInt(a.y, 10)))
						})
					}
			}
			me.game.renderer.adjustPosition(this), me.TMXUtils.applyTMXProperties(this, a)
		},
		...
		getShape: function() {
			return this.isEllipse === !0 ? new me.Ellipse(new me.Vector2d(0, 0), this.width, this.height) : this.isPolygon === !0 || this.isPolyline === !0 ? new me.PolyShape(new me.Vector2d(0, 0), this.points, this.isPolygon) : new me.Rect(new me.Vector2d(0, 0), this.width, this.height)
		},
...
function() {
	...
	me.Tile = me.Rect.extend({
		...
		init: function(d, e, f, g, h) {
			this.parent(new me.Vector2d(d * f, e * g), f, g), this.col = d, this.row = e, this.tileId = h, this.flipX = 0 !== (this.tileId & a), this.flipY = 0 !== (this.tileId & b), this.flipAD = 0 !== (this.tileId & c), this.flipped = this.flipX || this.flipY || this.flipAD, this.flipped === !0 && this.createTransform(), this.tileId &= ~(a | b | c)
		},
		createTransform: function() {
			null === this.transform && (this.transform = new me.Matrix2d), this.transform.identity(), this.flipAD && (this.transform.set(0, 1, 1, 0), this.transform.translate(0, this.height - this.width)), this.flipX && (this.transform.a *= -1, this.transform.c *= -1, this.transform.translate(this.flipAD ? this.height : this.width, 0)), this.flipY && (this.transform.b *= -1, this.transform.d *= -1, this.transform.translate(0, this.flipAD ? this.width : this.height))
		}
		...
		tileYOffset: [],
		init: function(a) {
			this.firstgid = this.lastgid = a[me.TMX_TAG_FIRSTGID];
			var b = a[me.TMX_TAG_SOURCE];
			if (b && "tsx" === me.utils.getFileExtension(b).toLowerCase() && (b = me.utils.getBasename(b), a = me.loader.getTMX(b), !a)) throw "melonJS:" + b + " TSX tileset not found";
			this.name = a[me.TMX_TAG_NAME], this.tilewidth = parseInt(a[me.TMX_TAG_TILEWIDTH], 10), this.tileheight = parseInt(a[me.TMX_TAG_TILEHEIGHT], 10), this.spacing = parseInt(a[me.TMX_TAG_SPACING] || 0, 10), this.margin = parseInt(a[me.TMX_TAG_MARGIN] || 0, 10), this.tileoffset = new me.Vector2d(0, 0);
			var c = a[me.TMX_TAG_TILEOFFSET];
			c && (this.tileoffset.x = parseInt(c[me.TMX_TAG_X], 10), this.tileoffset.y = parseInt(c[me.TMX_TAG_Y], 10));
			var d = a.tileproperties;
			if (d)
				for (var e in d) d.hasOwnProperty(e) && this.setTileProperty(parseInt(e, 10) + this.firstgid, d[e]);
			else if (a[me.TMX_TAG_TILE]) {
				d = a[me.TMX_TAG_TILE], Array.isArray(d) || (d = [d]);
				for (var f = 0; f < d.length; f++) {
					var g = d[f][me.TMX_TAG_ID] + this.firstgid,
						h = {};
					me.TMXUtils.applyTMXProperties(h, d[f]), this.setTileProperty(g, h)
				}
			}
			var i = "string" == typeof a[me.TMX_TAG_IMAGE] ? a[me.TMX_TAG_IMAGE] : a[me.TMX_TAG_IMAGE].source;
			if (i = me.utils.getBasename(i), this.image = i ? me.loader.getImage(i) : null, this.image) {
		...
		drawTile: function(a, b, c, d) {
			if (d.flipped) {
				a.save();
				var e = d.transform;
				a.transform(e.a, e.b, e.c, e.d, e.e + b, e.f + c), b = c = 0
			}
			var f = d.tileId - this.firstgid;
			a.drawImage(this.image, this.getTileOffsetX(f), this.getTileOffsetY(f), this.tilewidth, this.tileheight, b, c, this.tilewidth, this.tileheight), d.flipped && a.restore()
		}
...
function() {
	me.TMXOrthogonalRenderer = Object.extend({
		...
		pixelToTileCoords: function(a, b) {
			a -= this.originX;
			var c = b / this.tileheight,
				d = a / this.tilewidth;
			return new me.Vector2d(c + d, c - d)
		},
		tileToPixelCoords: function(a, b) {
		...
		adjustPosition: function(a) {
			...
			d.x -= a.width / 2, d.y -= a.height, a.x = d.x, a.y = d.y
		},
		drawTile: function(a, b, c, d, e) {
...
function() {
	me.ColorLayer = me.Renderable.extend({
		init: function(a, b, c) {
			this.parent(new me.Vector2d(0, 0), 1 / 0, 1 / 0), this.name = a, this.color = b, this.z = c
		},
		draw: function(a, b) {
			var c = a.globalAlpha;
			a.globalAlpha *= this.getOpacity(), a.fillStyle = this.color, a.fillRect(b.left, b.top, b.width, b.height), a.globalAlpha = c
		}
	}), me.ImageLayer = me.Renderable.extend({
		init: function(a, b, c, d, e, f) {
			if (this.name = a, this.image = d ? me.loader.getImage(me.utils.getBasename(d)) : null, !this.image) throw "melonJS: '" + d + "' file for Image Layer '" + this.name + "' not found!";
			this.imagewidth = this.image.width, this.imageheight = this.image.height;
			var g = me.game.viewport;
			b = b ? Math.min(g.width, b) : g.width, c = c ? Math.min(g.height, c) : g.height, this.parent(new me.Vector2d(0, 0), b, c), this.z = e, this.ratio = new me.Vector2d(1, 1), "undefined" != typeof f && ("number" == typeof f ? this.ratio.set(f, f) : this.ratio.setV(f)), this.lastpos = g.pos.clone(), this.floating = !0, this._repeat = "repeat", this.repeatX = !0, this.repeatY = !0, Object.defineProperty(this, "repeat", {
				get: function() {
					return this._repeat
				},
				set: function(a) {
		...
		draw: function(a, b) {
			var c = me.game.viewport,
				d = 0 !== this.anchorPoint.y || 0 !== this.anchorPoint.x,
				e = ~~ (this.anchorPoint.x * (c.width - this.imagewidth)),
				f = ~~ (this.anchorPoint.y * (c.height - this.imageheight));
			d && a.translate(e, f), a.globalAlpha *= this.getOpacity();
			var g, h;
		...
		init: function(a, b) {
			this.parent(new me.Vector2d(0, 0), a, b), this.isCollisionMap = !0
		},
		checkCollision: function(a, b) {
			var c = b.x < 0 ? a.left + b.x : a.right + b.x,
				d = b.y < 0 ? a.top + b.y : a.bottom + b.y,
				e = {
					x: 0,
					y: 0,
					xprop: {},
			...
			return (0 >= c || c >= this.width) && (e.x = b.x), (0 >= d || d >= this.height) && (e.y = b.y), e
		}
	}), me.TMXLayer = me.Renderable.extend({
		layerData: null,
		init: function(a, b, c, d, e) {
			this.parent(new me.Vector2d(0, 0), 0, 0), this.tilewidth = a, this.tileheight = b, this.orientation = c, this.tilesets = d, this.tileset = this.tilesets ? this.tilesets.getTilesetByIndex(0) : null, this.z = e
		},
		initFromJSON: function(a) {
			this.name = a[me.TMX_TAG_NAME], this.cols = parseInt(a[me.TMX_TAG_WIDTH], 10), this.rows = parseInt(a[me.TMX_TAG_HEIGHT], 10);
			var b = "undefined" != typeof a[me.TMX_TAG_VISIBLE] ? a[me.TMX_TAG_VISIBLE] : !0;
			this.setOpacity(b ? parseFloat(a[me.TMX_TAG_OPACITY]) : 0), this.width = this.cols * this.tilewidth, this.height = this.rows * this.tileheight, me.TMXUtils.applyTMXProperties(this, a), "undefined" == typeof this.preRender && (this.preRender = me.sys.preRender), this.isCollisionMap = this.name.toLowerCase().contains(me.COLLISION_LAYER), this.isCollisionMap === !0 && this.setOpacity(0), this.preRender === !0 && (this.layerCanvas = me.video.createCanvas(this.cols * this.tilewidth, this.rows * this.tileheight), this.layerSurface = me.video.getContext2d(this.layerCanvas))
		},
		destroy: function() {
			this.preRender && (this.layerCanvas = null, this.layerSurface = null), this.renderer = null, this.layerData = null, this.tileset = null, this.tilesets = null
		},
		...
		getTile: function(a, b) {
			return this.layerData[~~(a / this.tilewidth)][~~(b / this.tileheight)]
		},
		...
		checkCollision: function(a, b) {
			var c = b.x < 0 ? ~~(a.left + b.x) : Math.ceil(a.right - 1 + b.x),
				d = b.y < 0 ? ~~(a.top + b.y) : Math.ceil(a.bottom - 1 + b.y),
				e = {
					x: 0,
					xtile: void 0,
					xprop: {},
		...
		draw: function(a, b) {
			if (this.preRender) {
				...
				var e = a.globalAlpha;
				a.globalAlpha *= this.getOpacity(), a.globalAlpha > 0 && this.renderer.drawTileLayer(a, this, b), a.globalAlpha = e
			}
		}
	})
}(),
function() {
	me.TMXTileMap = me.Renderable.extend({
		init: function(a) {
			this.levelId = a, this.z = 0, this.name = null, this.cols = 0, this.rows = 0, this.tilewidth = 0, this.tileheight = 0, this.tilesets = null, this.mapLayers = [], this.objectGroups = [], this.version = "", this.orientation = "", this.tilesets = null, this.initialized = !1, this.parent(new me.Vector2d, 0, 0)
		},
		getObjectGroupByName: function(a) {
			var b = null;
			a = a.trim().toLowerCase();
			for (var c = this.objectGroups.length; c--;)
				if (this.objectGroups[c].name.toLowerCase().contains(a)) {
		...
		getLayerByName: function(a) {
			...
			return a.toLowerCase().contains(me.COLLISION_LAYER) && null == b && (b = new me.CollisionTiledLayer(me.game.currentLevel.width, me.game.currentLevel.height)), b
		},
		clearTile: function(a, b) {
...
function() {
	me.TMXMapReader = Object.extend({
		...
		readMap: function(b) {
			if (!b.initialized) {
				if (null === this.JSONReader && (this.JSONReader = new a), this.JSONReader.readJSONMap(b, me.loader.getTMX(b.levelId)), b.width < me.game.viewport.width || b.height < me.game.viewport.height) {
					var c = ~~ ((me.game.viewport.width - b.width) / 2),
						d = ~~ ((me.game.viewport.height - b.height) / 2);
					b.pos.add({
						x: c > 0 ? c : 0,
						y: d > 0 ? d : 0
					})
		...
		getNewDefaultRenderer: function(a) {
			switch (a.orientation) {
				...
				default:
					throw "melonJS: " + a.orientation + " type TMX Tile Map not supported!"
			}
		},
		setLayerData: function(a, b, c, d) {
			a.initArray(a.cols, a.rows);
			var e = Array.isArray(b) === !0 ? b : b.value;
			switch (c) {
				case "json":
					e = b;
					break;
				...
				case me.TMX_TAG_ATTR_BASE64:
					c === me.TMX_TAG_CSV ? e = me.utils.decodeCSV(e, a.cols) : (e = me.utils.decodeBase64AsArray(e, 4), null !== d && (e = me.utils.decompress(e, d)));
					break;
				default:
					throw "melonJS: TMX Tile Map " + c + " encoding not supported!"
			}
			for (var f = 0, g = 0; g < a.rows; g++)
				for (var h = 0; h < a.cols; h++) {
					var i = null == c ? this.TMXParser.getIntAttribute(e[f++], me.TMX_TAG_GID) : e[f++];
					if (0 !== i) {
						var j = a.setTile(h, g, i);
						a.preRender && a.renderer.drawTile(a.layerSurface, h, g, j, j.tileset)
					}
				}
		}
	});
	var a = me.TMXMapReader.extend({
		readJSONMap: function(a, b) {
			if (!b) throw "melonJS:" + a.levelId + " TMX map not found";
			var c = 0,
				d = this;
			a.version = b[me.TMX_TAG_VERSION], a.orientation = b[me.TMX_TAG_ORIENTATION], a.cols = parseInt(b[me.TMX_TAG_WIDTH], 10), a.rows = parseInt(b[me.TMX_TAG_HEIGHT], 10), a.tilewidth = parseInt(b[me.TMX_TAG_TILEWIDTH], 10), a.tileheight = parseInt(b[me.TMX_TAG_TILEHEIGHT], 10), a.width = a.cols * a.tilewidth, a.height = a.rows * a.tileheight, a.backgroundcolor = b[me.TMX_BACKGROUND_COLOR], a.z = c++, me.TMXUtils.applyTMXProperties(a, b), a.backgroundcolor && a.mapLayers.push(new me.ColorLayer("background_color", a.backgroundcolor, c++)), a.background_image && a.mapLayers.push(new me.ImageLayer("background_image", a.width, a.height, a.background_image, c++)), null !== me.game.renderer && me.game.renderer.canRender(a) || (me.game.renderer = this.getNewDefaultRenderer(a)), a.tilesets || (a.tilesets = new me.TMXTilesetGroup);
			var e = b.tilesets || b.tileset;
			if (Array.isArray(e) === !0 ? e.forEach(function(b) {
				a.tilesets.add(d.readTileset(b))
			}) : a.tilesets.add(d.readTileset(e)), "undefined" != typeof b.layers) b.layers.forEach(function(b) {
				switch (b.type) {
					case me.TMX_TAG_IMAGE_LAYER:
						a.mapLayers.push(d.readImageLayer(a, b, c++));
						break;
					case me.TMX_TAG_TILE_LAYER:
						a.mapLayers.push(d.readLayer(a, b, c++));
						break;
					case me.TMX_TAG_OBJECTGROUP:
						a.objectGroups.push(d.readObjectGroup(a, b, c++))
				}
			});
			else if ("undefined" != typeof b.layer) {
				var f = b.layer;
				if (Array.isArray(f) === !0 ? f.forEach(function(b) {
					a.mapLayers.push(d.readLayer(a, b, b._draworder))
				}) : a.mapLayers.push(d.readLayer(a, f, f._draworder)), "undefined" != typeof b[me.TMX_TAG_OBJECTGROUP]) {
					var g = b[me.TMX_TAG_OBJECTGROUP];
					Array.isArray(g) === !0 ? g.forEach(function(b) {
						a.objectGroups.push(d.readObjectGroup(a, b, b._draworder))
					}) : a.objectGroups.push(d.readObjectGroup(a, g, g._draworder))
				}
				if ("undefined" != typeof b[me.TMX_TAG_IMAGE_LAYER]) {
					var h = b[me.TMX_TAG_IMAGE_LAYER];
					Array.isArray(h) === !0 ? h.forEach(function(b) {
						a.mapLayers.push(d.readImageLayer(a, b, b._draworder))
					}) : a.mapLayers.push(d.readImageLayer(a, h, h._draworder))
				}
			}
		},
		readLayer: function(a, b, c) {
			var d = new me.TMXLayer(a.tilewidth, a.tileheight, a.orientation, a.tilesets, c);
			d.initFromJSON(b), d.setRenderer(me.game.renderer.canRender(d) ? me.game.renderer : me.mapReader.getNewDefaultRenderer(d));
			var e = Array.isArray(b[me.TMX_TAG_DATA]) ? b[me.TMX_TAG_ENCODING] : b[me.TMX_TAG_DATA][me.TMX_TAG_ENCODING];
			return this.setLayerData(d, b[me.TMX_TAG_DATA], e || "json", null), d
		},
		readImageLayer: function(a, b, c) {
			var d = b[me.TMX_TAG_NAME],
				e = parseInt(b[me.TMX_TAG_WIDTH], 10),
				f = parseInt(b[me.TMX_TAG_HEIGHT], 10),
				g = "string" != typeof b[me.TMX_TAG_IMAGE] ? b[me.TMX_TAG_IMAGE].source : b[me.TMX_TAG_IMAGE],
				h = new me.ImageLayer(d, e * a.tilewidth, f * a.tileheight, g, c),
				i = "undefined" != typeof b[me.TMX_TAG_VISIBLE] ? b[me.TMX_TAG_VISIBLE] : !0;
			return h.setOpacity(i === !0 ? parseFloat(b[me.TMX_TAG_OPACITY] || 1).clamp(0, 1) : 0), me.TMXUtils.applyTMXProperties(h, b), "number" == typeof h.ratio && (h.ratio = new me.Vector2d(parseFloat(h.ratio), parseFloat(h.ratio))), h
		},
		readTileset: function(a) {
			return new me.TMXTileset(a)
		},
		readObjectGroup: function(a, b, c) {
			return new me.TMXObjectGroup(b[me.TMX_TAG_NAME], b, a.tilesets, c)
		}
	})
}(),
function() {
	me.levelDirector = function() {
		var a = {},
			...
			d = 0,
			e = function(a, b) {
				b.autoSort = !1, me.game.currentLevel = a, me.game.collisionMap = me.game.currentLevel.getLayerByName("collision"), me.game.collisionMap && me.game.collisionMap.isCollisionMap || console.error("WARNING : no collision map detected");
				for (var c = a.getLayers(), d = c.length; d--;) b.addChild(c[d]);
				me.game.viewport.setBounds(0, 0, Math.max(a.width, me.game.viewport.width), Math.max(a.height, me.game.viewport.height));
				for (var e = b, f = a.getObjectGroups(), g = 0; g < f.length; g++) {
					var h = f[g];
					me.game.mergeGroup === !1 && (e = new me.ObjectContainer, e.name = h.name, e.z = h.z, e.setOpacity(h.opacity), e.autoSort = !1);
					for (var i = 0; i < h.objects.length; i++) {
						var j = h.objects[i],
							k = me.pool.pull(j.name, j.x, j.y, "TileObject" === j.name ? j.image : j);
						k && (k.z = h.z, me.game.mergeGroup === !0 && k.isRenderable === !0 && (k.setOpacity(k.getOpacity() * h.opacity), null !== k.renderable && "object" == typeof k.renderable && k.renderable.isRenderable === !0 && k.renderable.setOpacity(k.renderable.getOpacity() * h.opacity)), e.addChild(k))
					}
					me.game.mergeGroup === !1 && (b.addChild(e), e.autoSort = !0)
				}
				b.sort(!0), b.autoSort = !0, me.game.world.transform.translateV(me.game.currentLevel.pos), me.game.onLevelLoaded && me.game.onLevelLoaded.call(me.game.onLevelLoaded, a.name), me.event.publish(me.event.LEVEL_LOADED, [a.name])
			};
		return a.reset = function() {}, a.addLevel = function() {
			...
			if (f = f.toString().toLowerCase(), "undefined" == typeof b[f]) throw "melonJS: level " + f + " not found";
			if (!(b[f] instanceof me.TMXTileMap)) throw "melonJS: no level loader defined";
			var g = me.state.isRunning();
			return g && me.state.stop(), me.game.reset(), me.utils.resetGUID(f), b[a.getCurrentLevelId()] && b[a.getCurrentLevelId()].destroy(), me.mapReader.readMap(b[f]), d = c.indexOf(f), e(b[f], me.game.world), g && me.state.restart.defer(this), !0
...
function() {
	me.Tween = function(a) {
		var b = a,
			...
			q = null,
			r = null;
		for (var s in a) c[s] = parseFloat(a[s], 10);
		this.onResetEvent = function(a) {
			...
			if ("function" != typeof a) throw "melonJS: invalid easing function for me.Tween.easing()";
			return l = a, this
...
function() {
	...
	if (k.prototype = {
		load: function() {
			...
			for (var e = 0; e < b._urls.length; e++) {
				...
				if (b._format) f = b._format;
					...
					if (i = b._urls[e].toLowerCase().split("?")[0], f = i.match(/.+\.([^?]+)(\?|$)/), f = f && f.length >= 2 ? f : i.match(/data\:audio\/([^?]+);/), !f) return void b.on("loaderror");
					f = f[1]
				} if (j[f]) {
					c = b._urls[e];
					break
			...
			if (b._src = c, b._webAudio) l(b, c);
				...
				k.addEventListener("error", function() {
					k.error && 4 === k.error.code && (g.noAudio = !0), b.on("loaderror", {
						type: k.error ? k.error.code : 0
					})
				}, !1), b._audioNode.push(k), k.src = c, k._pos = 0, k.preload = "auto", k.volume = h._muted ? 0 : b._volume * h.volume(), a[c] = b;
				var m = function() {
					b._duration = Math.ceil(10 * k.duration) / 10, 0 === Object.getOwnPropertyNames(b._sprite).length && (b._sprite = {
						_default: [0, 1e3 * b._duration]
					}), b._loaded || (b._loaded = !0, b.on("load")), b._autoplay && b.play(), k.removeEventListener("canplaythrough", m, !1)
				};
				k.addEventListener("canplaythrough", m, !1), k.load()
			}
			return b
		},
		urls: function(a) {
			...
			return "function" == typeof a && (c = a), a && "function" != typeof a || (a = "_default"), d._loaded ? d._sprite[a] ? (d._inactiveNode(function(e) {
				...
				if (function() {
					...
					f = setTimeout(function() {
						!d._webAudio && j && d.stop(b.id).play(a, b.id), d._webAudio && !j && (d._nodeById(b.id).paused = !0, d._nodeById(b.id)._pos = 0), d._webAudio || j || d.stop(b.id), d.on("end", k)
					}, 1e3 * i), d._onendTimer.push({
						timer: f,
						id: b.id
					})
				}(), d._webAudio) {
					...
					e.readyState = 4, e.id = k, e.currentTime = g, e.muted = h._muted || e.muted, e.volume = d._volume * h.volume(), setTimeout(function() {
						e.play()
					}, 0)
				}
		...
		pause: function(a) {
			...
			if (c)
				if (c._pos = b.pos(null, a), b._webAudio) {
					...
					c.paused = !0, "undefined" == typeof c.bufferSource.stop ? c.bufferSource.noteOff(0) : c.bufferSource.stop(0)
				} else c.pause();
			return b.on("pause"), b
		},
		stop: function(a) {
		...
		_inactiveNode: function(a) {
			...
			if (b._drainPool(), !c) {
				var e;
				b._webAudio ? (e = b._setupAudioNode(), a(e)) : (b.load(), e = b._audioNode[b._audioNode.length - 1], e.addEventListener(navigator.isCocoonJS ? "canplaythrough" : "loadedmetadata", function() {
					a(e)
				}))
			}
		},
		...
		_clearEndTimer: function(a) {
			for (var b = this, c = 0, d = 0; d < b._onendTimer.length; d++)
				if (b._onendTimer[d].id === a) {
					c = d;
					break
				}
	...
	}), "undefined" != typeof exports && (exports.Howler = h, exports.Howl = k), "undefined" != typeof window && (window.Howler = h, window.Howl = k)
}(),
function() {
	me.plugin = function() {
		var a = {};
		return a.Base = Object.extend({
			...
			if (me.plugin[b] && console.error("plugin " + b + " already registered"), "undefined" == typeof a.prototype.version) throw "melonJS: Plugin version not defined!";
			if (me.sys.checkVersion(a.prototype.version) > 0) throw "melonJS: Plugin version mismatch, expected: " + a.prototype.version + ", got: " + me.version;
			var c = [];
			if (arguments.length > 2 && (c = Array.prototype.slice.call(arguments, 1)), c[0] = a, me.plugin[b] = new(a.bind.apply(a, c)), !(me.plugin[b] instanceof me.plugin.Base)) throw "melonJS: Plugin should extend the me.plugin.Base Class !"
		}, a
	}()
	...
	return a.extend({
		init: function(a, c, e) {
			this.parent(a, c, e), this.dragging = !1, this.dragId = null, this.grabOffset = new d(0, 0), this.onPointerEvent = b.registerPointerEvent, this.removePointerEvent = b.releasePointerEvent, this.initEvents()
		},
		initEvents: function() {
			var a = this;
...
}(me.ObjectEntity, me.input, me.event, me.Vector2d), me.DroptargetEntity = function(a, b) {
	"use strict";
	return a.extend({
		...
		checkMethod: null,
		init: function(a, c, d) {
			this.parent(a, c, d), b.subscribe(b.DRAGEND, this.checkOnMe.bind(this)), this.checkMethod = this[this.CHECKMETHOD_OVERLAP]
		},
...
function() {
	...
	me.ParticleEmitterSettings = {
		...
		isRenderable: !1,
		init: function(a, b, c) {
			this.parent(new me.Vector2d(a, b), 1 / 0, 1 / 0), this.autoSort = !1, this.container = new me.ParticleContainer(this), Object.defineProperty(this, "z", {
				get: function() {
		...
		getRandomPoint: function() {
			...
			return a.x += Number.prototype.random(0, this.width), a.y += Number.prototype.random(0, this.height), a
		},
		reset: function(a) {
			a = a || {};
		...
		addParticles: function(a) {
			for (var b = 0;~~ a > b; b++) {
				...
				c.isRenderable = !1, this.container.addChild(c)
			}
		},
		isRunning: function() {
...
function() {
	me.ParticleContainer = me.ObjectContainer.extend({
		init: function(a) {
			this.parent(), this.autoSort = !1, this._updateCount = 0, this._dt = 0, this._emitter = a
		},
		update: function(a) {
		...
		draw: function(a, b) {
			if (this.children.length > 0) {
				var c;
				this._emitter.textureAdditive && (c = a.globalCompositeOperation, a.globalCompositeOperation = "lighter"), this.parent(a, b), this._emitter.textureAdditive && (a.globalCompositeOperation = c)
			}
		}
	})
}(),
function() {
	me.Particle = me.Renderable.extend({
		init: function(a) {
			this.parent(a.getRandomPoint(), a.image.width, a.image.height), this.alwaysUpdate = !0, this.image = a.image;
			var b = a.angle + (a.angleVariation > 0 ? (2 * Math.random() - 1) * a.angleVariation : 0),
				c = a.speed + (a.speedVariation > 0 ? (2 * Math.random() - 1) * a.speedVariation : 0);
			this.vel = new me.Vector2d(c * Math.cos(b), -c * Math.sin(b)), this.life = Number.prototype.random(a.minLife, a.maxLife), this.startLife = this.life, this.startScale = Number.prototype.random(a.minStartScale, a.maxStartScale).clamp(a.minStartScale, a.maxStartScale), this.endScale = Number.prototype.random(a.minEndScale, a.maxEndScale).clamp(a.minEndScale, a.maxEndScale), this.gravity = a.gravity, this.wind = a.wind, this.followTrajectory = a.followTrajectory, this.onlyInViewport = a.onlyInViewport, this.z = a.z, this._deltaInv = me.sys.fps / 1e3, this.transform = new me.Matrix2d, a.followTrajectory || (this.angle = Number.prototype.random(a.minRotation, a.maxRotation))
		},
		update: function(a) {
		...
		draw: function(a) {
			a.save(), a.globalAlpha *= this.alpha;
			var b = this.transform;
			a.transform(b.a, b.b, b.c, b.d, ~~this.pos.x, ~~this.pos.y);
			var c = this.width,
				d = this.height;
